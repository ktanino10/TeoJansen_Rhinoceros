...
3. **3Dプリント**  
   ...
   3Dプリンター出力中の画像：`./docs/images/88187.jpg`  
...
**400 → 600 → 800番** の順にやすりをかけ、滑らかな表面に仕上げています。  
   クランクシャフト研磨後の画像：`./docs/images/88075_0.jpg`  
   [研磨工程の動画](https://www.youtube.com/watch?v=w-jB8-OUFfA)

5. **塗装**  
   塗装ブースでエアブラシ塗装。  
研磨後のパーツを **超音波洗浄機** で洗浄しました。  
洗浄水には **少量の洗剤** を加え、表面張力を下げることで気泡が細部まで入り込み、微細な粉や削りカスを効果的に除去しています。  
   洗浄時の画像：`./docs/images/88073_0.jpg`  
