...
|------|----------------------------------|
| **斜めビュー** | <img src="./docs/images/88209_0.jpg" width="500" alt="クランクシャフト比較1 Before"> | <img src="./docs/images/88209_0.jpg" width="300" alt="クランクシャフト比較1 After"> |
| **側面ビュー** | <img src="./docs/images/88210_0.jpg" width="500" alt="クランクシャフト比較2 Before"> | <img src="./docs/images/88210_0.jpg" width="300" alt="クランクシャフト比較2 After"> |
| **グラデーション比較** | <img src="./docs/images//87814.jpg" width="500" alt="クランクシャフト比較3 Before"> | <img src="./docs/images//87814.jpg" width="300" alt="クランクシャフト比較3 After"> |

ABS樹脂の積層跡を丁寧に研磨し、エアブラシ塗装とつや消しトップコートで仕上げました。
これにより、滑らかで落ち着いた質感を実現し、機能性と造形美の両立を目指しています。
